...
driver.find_element(By.ID, "ctl00_PageContent_MemberProfileControl_CustomField_EmailAddress_0").send_keys(sys.argv[1])
driver.find_element(By.ID, "ctl00_PageContent_MemberProfileControl_CustomField_EmailAddress_1").send_keys(sys.argv[1])
